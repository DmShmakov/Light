...
## Зависимости
- Issue #1 (VAPID-ключи, fcm_tokens коллекция)
...
```json
{
  "title": "string",
  "body": "string",
  "data": { "type": "string", "classId": "string" },
...
for i, issue in enumerate(issues):
    print(f"Creating issue #{i+2}: {issue['title']}...")
    resp = requests.post(API, headers=HEADERS, json=issue)
