...
describe('AdminCreateClassPage — логика автозаполнения endDateTime', () => {
  test('endDateTime = startDateTime + 1 час', () => {
    // Тестируем логику из AdminCreateClassPage:
    ...
    expect(endDate.getTime() - startDateTime.getTime()).toBe(60 * 60 * 1000) // 1 час в мс
  })

  test('endDateTime = startDateTime + 1 час (через разные часовые пояса)', () => {
    const testCases = [
